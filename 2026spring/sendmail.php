...
$subject_user = "[名門会] 2026春期特別講習会のお問い合わせありがとうございます。";
$subject_admin = "【2026春期特別講習会LP】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
2026春期特別講習会LPより個別相談のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。
...
この度は、名門会の2026春期特別講習会についてお問い合わせいただき、誠にありがとうございます。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/2026spring/thanks.html",
