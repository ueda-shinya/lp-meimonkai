...
<html lang="ja">
  ...
  <head>
    ...
    <title>入学してから焦らないために、いま始める大学準備|名門会</title>
  ...
  <body>
    ...
    <main>
      <div class="cta-area header-wrapper">
        <h1>
          <img src="./assets/images/fv.webp" alt="入学してから焦らないために、いま始める大学準備" width="750" height="1450">
        </h1>
        <a href="#contact-form">
          <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/cta.webp" alt="無料個別相談受付中" width="744" height="190"
            decoding="async" loading="lazy">
        </a>
      </div>
      <img src="./assets/images/page1.webp" width="750" height="2176" decoding="async" loading="lazy">
      <img src="./assets/images/page2.webp" width="750" height="2822" decoding="async" loading="lazy">
      <img src="./assets/images/page3.webp" width="748" height="1798" decoding="async" loading="lazy">
      <img src="./assets/images/page4.webp" width="748" height="1394" decoding="async" loading="lazy">
      <img src="./assets/images/page5.webp" width="750" height="1799" decoding="async" loading="lazy">
      <img src="./assets/images/page6.webp" width="750" height="2442" decoding="async" loading="lazy">
    ...
    <footer style="display:none;">
      <a class="footer_a" href="#contact-form">
        <img src="./assets/images/cta.webp" alt="無料個別相談受付中" width="744" height="190" decoding="async" loading="lazy">
      </a>
    </footer>
    <!-- スクリプト -->
