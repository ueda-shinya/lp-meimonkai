...
$admin_email = "onlinecenter@meimonkai.co.jp,kubota@meimonkai.co.jp,mottomops@meimonkai.co.jp,info@linnoa.net";
...
$subject_user = "[名門会] お問い合わせありがとうございます。";
$subject_admin = "【MOPS南柏校LP】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
【MOPS南柏校LP】より無料体験のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。
...
【学年】 {$grade}
【郵便番号】 {$zipcode} 
【ご住所】 {$pref} {$city} {$address} {$building}
【電話番号】 {$tel}
【メールアドレス】 {$email}
...
この度は、名門会の無料体験にお申し込みいただき、誠にありがとうございます。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/mops_minamikashiwa/thanks.html",
