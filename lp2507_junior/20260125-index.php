...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-TJRTLL2G');
  </script>
  <!-- End Google Tag Manager -->
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="">
  <title>受験の合格は、親が決断した夏で決まる|名門会</title>
  ...
  <link rel="stylesheet" type="text/css" href="/lp/lp2507_junior/assets/css/destyle.css">
  <link rel="stylesheet" href="/lp/lp2507_junior/assets/css/style.css?20251123">
  <link href="https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@400;700&display=swap" rel="stylesheet">
</head>

<body>
  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TJRTLL2G"
  ...
  <main>
    <h1>
      <img src="/lp/lp2507_junior/assets/images/c-fv@2x.webp" alt="受験の合格は、親が決断した夏で決まる|名門会" width="375" height="650">
    </h1>
    <img src="/lp/lp2507_junior/assets/images/c-page1@2x.webp" alt="" width="375" height="2109" decoding="async" loading="lazy">
    <img src="/lp/lp2507_junior/assets/images/c-page2@2x.webp" alt="" width="375" height="2489" decoding="async" loading="lazy">
    <img src="/lp/lp2507_junior/assets/images/c-page3@2x.webp" alt="" width="375" height="2437" decoding="async" loading="lazy">
    <img src="/lp/lp2507_junior/assets/images/c-page4@2x.webp" alt="" width="375" height="2556" decoding="async" loading="lazy">
    <form id="contact-form" name="contact" action="sendmail.php" method="POST">
      ...
      <!-- 郵便番号 自動入力対応 -->
      <div>
        <label>郵便番号 <span style="color:red;font-size:0.75em;">※必須</span><input type="text" name="postcode" placeholder="" required>
        </label>
      </div>
      <div>
    ...
    <!--  -->
    <img src="/lp/lp2507_junior/assets/images/c-page5@2x.webp" alt="" width="375" height="979" decoding="async" loading="lazy">
    <img src="/lp/lp2507_junior/assets/images/c-page6@2x.webp" alt="" width="375" height="1408" decoding="async" loading="lazy">
  </main>
  <footer style="display:none;">
    <a class="line" href="https://s.lmes.jp/landing-qr/2007617222-1n9Yk5vX?uLand=QBwo7B">
      <img src="/lp/lp2507_junior/assets/images/c-line-cta@2x.webp" alt="" width="187" height="92">
    </a>
    <a class="apply" href="#contact-form">
      <!-- w:328 -->
      <img src="/lp/lp2507_junior/assets/images/c-apply-cta@2x.webp" alt="" width="187" height="53">
    </a>
    <a class="tel" href="tel:0120ｰ14-3759">
      <img src="/lp/lp2507_junior/assets/images/c-tel-cta@2x.webp" alt="0120ｰ14-3759" width="187" height="92">
    </a>
  </footer>
  <!-- スクリプト -->
