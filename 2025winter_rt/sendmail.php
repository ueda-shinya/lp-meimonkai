...
$subject_admin = "【冬季特別講習会LP※リタゲ用】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
冬期特別講習会LPより個別相談のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。

【ご希望の教室】 {$place}
【お名前】 {$name}
【フリガナ】 {$furigana}
【ご住所】 {$zipcode} {$pref} {$city}
【電話番号】 {$tel}
【メールアドレス】 {$email}
【性別】 {$gender}
【学年】 {$grade}
...
この度は、名門会の冬期特別講習会についてお問い合わせいただき、誠にありがとうございます。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/2025winter/thanks.html", 
