...
$subject_admin = "【新中一対策講座LP】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
新中一対策講座LPより個別相談のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/newjuniorhighschool2025/thanks.html", 
