...
<html lang="ja">
  ...
  <head>
    ...
    <title>中学入学から「好スタート」を切るために|名門会</title>
  ...
  <body>
    ...
    <main>
      <div class="cta-area header-wrapper">
        <h1>
          <img src="./assets/images/fv.webp" alt="中学入学から「好スタート」を切るために" width="750" height="1320">
        </h1>
        <a href="#contact-form">
          <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/cta.webp" alt="無料個別相談受付中" width="744" height="162"
            decoding="async" loading="lazy">
        </a>
      </div>
      <img src="./assets/images/page1.webp"  width="750" height="1105" decoding="async" loading="lazy">
      <img src="./assets/images/page2.webp"  width="750" height="5883" decoding="async" loading="lazy">
      <img src="./assets/images/page3.webp"  width="750" height="3762" decoding="async" loading="lazy">
      <img src="./assets/images/page4.webp"  width="750" height="2827" decoding="async" loading="lazy">
    ...
    <footer style="display:none;">
      <a class="footer_a" href="#contact-form">
        <img src="./assets/images/cta.webp" alt="無料個別相談受付中" width="744" height="162" decoding="async" loading="lazy">
      </a>
    </footer>
    <!-- スクリプト -->
