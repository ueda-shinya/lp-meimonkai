...
$subject_admin = "【MEDIC名門会LP】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
【MEDIC名門会LP】より無料特別相談のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。
...
この度は、名門会の無料特別相談にお申し込みいただき、誠にありがとうございます。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/medic/thanks.html",
