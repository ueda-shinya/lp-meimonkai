...
<html lang="ja">
  ...
  <head>
    ...
    <link rel="stylesheet" href="./assets/css/style.css?20251123">
  ...
  <body>
    ...
    <main>
      <div class="cta-area header-wrapper">
        <h1>
          <img src="./assets/images/fv@2x.webp" alt="受験直前!!最後の切り札＜入試直前・新学期準備＞特別講習" width="375" height="650">
        </h1>
        <div class="cta-btns fv-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/tel@2x.webp" alt="0120-14-3759" width="187"
              height="62" decoding="async" loading="lazy">
          </a>
          <a href="#contact-form" class="btn-mail_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/cta@2x.webp" alt="メールで相談する" width="152"
              height="72" decoding="async" loading="lazy">
          </a>
        </div>
      </div>
      <div class="cta-area cta-page1">
        <img src="./assets/images/page1@2x.webp" width="375" height="2676" decoding="async" loading="lazy">
        <a class="cta-page1_a __kirifuda" href="#kirifuda"></a>
        <a class="cta-page1_a __dash"  href="#dash"></a>
        <div id="kirifuda" class="__anchor"></div>
      </div>
      <img src="./assets/images/page2@2x.webp" width="376" height="2244" decoding="async" loading="lazy">
      <img id="dash" src="./assets/images/page3@2x.webp" width="374" height="3004" decoding="async" loading="lazy">
      <div class="cta-area">
        <img src="./assets/images/page4@2x.webp" width="750" height="1780" decoding="async" loading="lazy">
        <div class="cta-btns page04-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-page04 cta_a" src="./assets/images/tel@2x.webp" alt="0120-14-3759" width="187"
              height="62" decoding="async" loading="lazy">
          </a>
          <a href="#contact-form" class="btn-mail_a">
            <img class="btn-cta_img  cta-page04 cta_a" src="./assets/images/cta@2x.webp" alt="メールで相談する" width="152"
              height="72" decoding="async" loading="lazy">
          </a>
        </div>
      </div>
      <div class="cta-area">
        ...
        <!-- tel / mail -->
        <div class="cta-btns page05-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-page05 cta_a" src="./assets/images/tel@2x.webp" alt="0120-14-3759" width="187"
              height="62" decoding="async" loading="lazy">
          </a>
          <a href="#contact-form" class="btn-mail_a">
            <img class="btn-cta_img  cta-page05 cta_a" src="./assets/images/cta@2x.webp" alt="メールで相談する" width="152"
              height="72" decoding="async" loading="lazy">
          </a>
        </div>
      </div>
      <img src="./assets/images/page6-n@2x.webp" width="375" height="3168" decoding="async" loading="lazy">
      <!--  -->
