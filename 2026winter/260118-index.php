...
<body>
  ...
  <main>
    <div class="cta-area header-wrapper">
      <h1>
        <img src="./assets/images/fv@2x.webp" alt="受験直前!!最後の切り札＜入試直前・新学期準備＞特別講習" width="375" height="1206">
      </h1>
    ...
    <img id="kirifuda" src="./assets/images/page3-2@2x.webp" width="375" height="2189" decoding="async" loading="lazy">
    <!--  -->
    <div class="cta-area">
