...
<html lang="ja">
  ...
  <head>
    ...
    <link rel="stylesheet" href="./assets/css/style.css?202512301252">
  ...
  <body>
    ...
    <main>
      <div class="cta-area header-wrapper">
        <h1>
          <img src="./assets/images/fv_01@2x.webp" alt="受験直前!!最後の切り札＜入試直前・新学期準備＞特別講習" width="375" height="1595">
        </h1>
        <a class="cta-page1_a __kirifuda" href="#kirifuda">
          <img src="./assets/images/btn-fv-taisaku@2x.webp" alt="志望校対策講座" width="359" height="138">
        </a>
        <a class="cta-page1_a __dash" href="#dash">
          <img src="./assets/images/btn-fv-startdash@2x.webp" alt="新学年スタートダッシュコース" width="359" height="137">
        </a>
        <div class="cta-btns fv-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/tel_cta@2x.webp" alt="0120-14-3759" width="371"
              height="128" decoding="async" loading="lazy">
          </a>
          <a href="#contact-form" class="btn-mail_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/mail_cta@2x.webp" alt="メールで相談する" width="371"
              height="95" decoding="async" loading="lazy">
          </a>
        </div>
      </div>
      <div id="dash" class="cta-area cta-page1">
        <img src="./assets/images/page1@2x.webp" width="374" height="3004" decoding="async" loading="lazy">
      </div>
      <img id="kirifuda" src="./assets/images/page2@2x.webp" width="375" height="2184" decoding="async" loading="lazy">
      <div class="cta-area">
        <img src="./assets/images/page3-1@2x.webp" width="375" height="1001" decoding="async" loading="lazy">
        <!-- tel / mail -->
        <div class="cta-btns page03-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/tel_cta@2x.webp" alt="0120-14-3759" width="187"
              height="62" decoding="async" loading="lazy">
          </a>
          <a href="#contact-form" class="btn-mail_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/mail_cta@2x.webp" alt="メールで相談する" width="152"
              height="72" decoding="async" loading="lazy">
          </a>
        </div>
      </div>
      <img id="kirifuda" src="./assets/images/page3-2@2x.webp" width="375" height="2189" decoding="async"
        loading="lazy">
      <!--  -->
      <div class="cta-area">
        <img src="./assets/images/page4@2x.webp" width="375" height="2992" decoding="async" loading="lazy">
        <!-- 4校 -->
        <div class="cta-schools">
          <!-- 1 -->
          <div class="cta-btns schools-btns">
            <a href="https://meimonkai.co.jp/middle/success/" class="btn-school_a" rel="nofollow noopener noreferrer"
              target="_blank">
              <img class="btn-cta_img  cta-school cta_a" src="./assets/images/j-btn@2x.webp" alt="中学受験合格体験談" width="177"
                height="57" decoding="async" loading="lazy">
            </a>
            <a href="https://meimonkai.co.jp/high/success/" class="btn-school_a" rel="nofollow noopener noreferrer"
              target="_blank">
              <img class="btn-cta_img  cta-school cta_a" src="./assets/images/h-btn@2x.webp" alt="高校受験合格体験談" width="177"
                height="57" decoding="async" loading="lazy">
            </a>
          </div>
          <!-- 2 -->
          <div class="cta-btns schools-btns">
            <a href="https://meimonkai.co.jp/university/success/" class="btn-school_a"
              rel="nofollow noopener noreferrer" target="_blank">
              <img class="btn-cta_img  cta-page05 cta_a" src="./assets/images/u-btn@2x.webp" alt="大学受験合格体験談" width="177"
                height="57" decoding="async" loading="lazy">
            </a>
            <a href="https://meimonkai.co.jp/medicine/success/" class="btn-school_a" rel="nofollow noopener noreferrer"
              target="_blank">
              <img class="btn-cta_img  cta-page05 cta_a" src="./assets/images/d-btn@2x.webp" alt="医学部受験合格体験談"
                width="177" height="57" decoding="async" loading="lazy">
            </a>
          </div>
        </div>
        <!--  -->
        <!-- tel / mail -->
        <div class="cta-btns page04-btns">
          <a href="tel:0120-14-3759" class="btn-tel_a">
            <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/tel_cta@2x.webp" alt="0120-14-3759" width="187"
              height="62" decoding="async" loading="lazy">
          </a>
      ...
      <div class="cta-area">
        <img src="./assets/images/page5@2x.webp" width="375" height="2993" decoding="async" loading="lazy">
      </div>
      <!--  -->
