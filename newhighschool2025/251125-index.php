...
<html lang="ja">
  ...
  <head>
    ...
    <title>名門会の「新高1対策講座」で、スタートダッシュを切ろう。|名門会</title>
  ...
  <body>
    ...
    <main>
      <div class="cta-area header-wrapper">
        <h1>
          <img src="./assets/images/img_01.webp" alt="高校入学後の最初の１学期で差がつく!名門会の「新高1対策講座」で、スタートダッシュを切ろう。" width="750"
            height="1300">
        </h1>
        <a href="#contact-form">
          <img class="btn-cta_img  cta-fv cta_a" src="./assets/images/cta.webp" alt="無料個別相談受付中" width="747" height="193"
            decoding="async" loading="lazy">
        </a>
      </div>
      <img src="./assets/images/img_02.webp" width="750" height="2260" decoding="async" loading="lazy">
      <img src="./assets/images/img_03.webp" width="750" height="2260" decoding="async" loading="lazy">
      <img src="./assets/images/img_04.webp" width="750" height="2100" decoding="async" loading="lazy">
      <img src="./assets/images/img_05.webp" width="750" height="1780" decoding="async" loading="lazy">
      <img src="./assets/images/img_06.webp" width="750" height="1580" decoding="async" loading="lazy">
      <img src="./assets/images/img_07.webp" width="750" height="1572" decoding="async" loading="lazy">
      <img src="./assets/images/img_08.webp" width="750" height="1580" decoding="async" loading="lazy">
      <!--  -->
