...
$subject_admin = "【新高一対策講座LP】お問い合わせフォームから問い合わせがありました";

$body_admin = <<<EOT
新高一対策講座LPより個別相談のお申込がはいりましたので、ご確認とご対応よろしくお願いいたします。
...
この度は、名門会の新高一対策講座についてお問い合わせいただき、誠にありがとうございます。
...
if ($success_user && $success_admin) {
  ...
  echo json_encode([
    "status" => "success",
    "redirect" => "https://meimonkai.co.jp/lp/newhighschool2025/thanks.html", 
